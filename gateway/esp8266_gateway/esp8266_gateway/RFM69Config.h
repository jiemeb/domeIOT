...
/*PROGMEM */ static const uint8_t CONFIG[][2] =
{
  ...
  /*  { RFM69_REG_03_BITRATE_MSB, 0x3E}, // 2000 bps
   ...
   { RFM69_REG_03_BITRATE_MSB, 0x0D}, // 9600 bps
    { RFM69_REG_04_BITRATE_LSB, 0x0D},
    
  /*  { RFM69_REG_05_FDEV_MSB,    0x00}, // 12000 hz (24000 hz shift)
    { RFM69_REG_06_FDEV_LSB,    0xC5}, */
    
     { RFM69_REG_05_FDEV_MSB,    0x05}, // 1600 hz (3200 hz shift)
    { RFM69_REG_06_FDEV_LSB,    0xC3},



    { RFM69_REG_07_FRF_MSB,     0x6C }, // 433 MHz
    { RFM69_REG_08_FRF_MID,     0x80 }, //  40
    { RFM69_REG_09_FRF_LSB,     0x00 }, // 00 

/*    { RFM69_REG_07_FRF_MSB,     0xD9 }, // 869.5 MHz
    { RFM69_REG_08_FRF_MID,     0x60 }, // calculated: 0x80?
    { RFM69_REG_09_FRF_LSB,     0x12 }, */
    
    { RFM69_REG_0B_AFC_CTRL,    RF_AFCLOWBETA_OFF }, // AFC Offset On RF_AFCLOWBETA_ON(peut etre)
   ...
   // { RFM69_REG_13_OCP,         RF_OCP_ON | RF_OCP_TRIM_95 },
    ...
    { RFM69_REG_1E_AFC_FEI,     RF_AFCFEI_FEI_START | RF_AFCFEI_AFCAUTO_ON | RF_AFCFEI_AFCAUTOCLEAR_ON }, // Automatic AFC on, clear after each packet(ajout start JMB)
    ...
    { RFM69_REG_2E_SYNC_CONFIG, RF_SYNC_ON | RF_SYNC_FIFOFILL_AUTO | RF_SYNC_SIZE_2 | RF_SYNC_TOL_0 },// Origine
    { RFM69_REG_2F_SYNCVALUE1, 0x2D },						//Origine
    { RFM69_REG_30_SYNCVALUE2, 0xD2 },						// Origine
 // { RFM69_REG_2E_SYNC_CONFIG, RF_SYNC_ON | RF_SYNC_FIFOFILL_AUTO | RF_SYNC_SIZE_4 | RF_SYNC_TOL_0 },
 // { RFM69_REG_2F_SYNCVALUE1, 0xAA }, 
 // { RFM69_REG_30_SYNCVALUE2, 0xAA },
 // { RFM69_REG_31_SYNCVALUE3, 0x2D },
  
 // { RFM69_REG_32_SYNCVALUE4, 0xD2 }, // Group ID ?
 ...
 //   { RFM69_REG_37_PACKET_CONFIG1, RF_PACKET1_FORMAT_VARIABLE | RF_PACKET1_DCFREE_OFF | RF_PACKET1_CRC_ON | RF_PACKET1_CRCAUTOCLEAR_ON | RF_PACKET1_ADRSFILTERING_OFF },
    { RFM69_REG_37_PACKET_CONFIG1, RF_PACKET1_FORMAT_FIXED | RF_PACKET1_DCFREE_OFF | RF_PACKET1_CRC_OFF | RF_PACKET1_CRCAUTOCLEAR_ON | RF_PACKET1_ADRSFILTERING_OFF },
...
//    { RFM69_REG_3B_AUTOMODES, RF_AUTOMODES_ENTER_FIFONOTEMPTY | RF_AUTOMODES_EXIT_PACKETSENT | RF_AUTOMODES_INTERMEDIATE_TRANSMITTER },
    ...
    { RFM69_REG_3D_PACKET_CONFIG2, RF_PACKET2_RXRESTARTDELAY_2BITS | RF_PACKET2_AUTORXRESTART_OFF | RF_PACKET2_AES_OFF }, //RXRESTARTDELAY must match transmitter PA ramp-down time (bitrate dependent)
